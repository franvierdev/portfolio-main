...
export default function Technologies() {
  return (
    <section className="flex flex-col max-sm:text-center py-10 ">
      <h2 className=" inline-block mx-auto text-5xl font-bold underline">
        Skills
      </h2>
      <ul className="flex  max-sm:grid max-sm:grid-cols-2 justify-between place-items-center max-w-5xl text-center gap-10 mx-auto lg:my-10 mt-10">
        <li className="flex flex-col gap-y-2">
          <svg
            ...
            aria-hidden="true"
            role="img"
            className="mx-auto iconify lg:w-16 lg:h-16"
            width="39.6px"
            height="39.5px"
            viewBox="0 0 24 24"
          >
        ...
        <li className="flex flex-col gap-y-2">
          <svg
            ...
            aria-hidden="true"
            role="img"
            className="mx-auto iconify iconify--teenyicons  lg:w-14 lg:h-14"
            width="39.6px"
            height="39.5px"
            viewBox="0 0 15 15"
          >
        ...
        <li className="flex flex-col gap-y-2">
          <svg
            ...
            aria-hidden="true"
            role="img"
            className="mx-auto iconify lg:w-14 lg:h-14"
            width="39.6px"
            height="39.5px"
            viewBox="0 0 24 24"
          >
        ...
        <li className="flex flex-col gap-y-2">
          <Image
            ...
            width={39.6}
            height={39.6}
            className=" max-sm:max-w-xs bg-white mx-auto  lg:w-14 lg:h-14"
          />
        ...
        <li className="flex flex-col gap-y-2">
          <Image
            ...
            width={39.6}
            height={39.6}
            className=" max-sm:max-w-xs  lg:w-14 lg:h-14 "
          />
          <p className="">Vite</p>
        </li>
        <li className="flex flex-col gap-y-2">
          <Image
            ...
            width={39.6}
            height={39.6}
            className=" max-sm:max-w-xs p-1 mx-auto  lg:w-14 lg:h-14"
          />
